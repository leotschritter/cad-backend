microservices = {
  comment = {
    ...
    ingress_url  = "https://cl.develop.tripico.fun"
    path_prefix  = "/comment"
  ...
  itinerary = {
    ...
    ingress_url  = "https://itinerary.develop.tripico.fun"
  ...
  travel-warnings = {
    ...
    ingress_url  = "https://warnings.develop.tripico.fun"
  ...
  weather = {
    ...
    ingress_url  = "https://weather.develop.tripico.fun"
  ...
  feed = {
    ...
    ingress_url  = "https://recommendation.develop.tripico.fun"
    path_prefix  = "/feed"
