microservices = {
  comment = {
    ...
    ingress_url  = "https://cl-freemium.dev.tripico.fun"
    path_prefix  = "/comment"
  ...
  itinerary = {
    ...
    ingress_url  = "https://itinerary-freemium.dev.tripico.fun"
  ...
  travel-warnings = {
    ...
    ingress_url  = "https://warnings-freemium.dev.tripico.fun"
  ...
  weather = {
    ...
    ingress_url  = "https://weather-freemium.dev.tripico.fun"
  ...
  feed = {
    ...
    ingress_url  = "https://recommendation-freemium.dev.tripico.fun"
    path_prefix  = "/feed"
